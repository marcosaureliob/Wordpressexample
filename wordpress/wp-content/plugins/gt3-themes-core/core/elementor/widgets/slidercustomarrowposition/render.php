	...
	<div <?php $widget->print_render_attribute_string('wrapper') ?>>
		<?php
			if ($widget->is_editor && current_user_can('edit_post', $post_id)) {
				echo '<div class="slick-prev slick-arrow gt3_modified"><div class="slick_arrow_icon"></div></div><div class="slick-next slick-arrow gt3_modified"><div class="slick_arrow_icon"></div></div>';
			}
		?>
	</div>
<?php
