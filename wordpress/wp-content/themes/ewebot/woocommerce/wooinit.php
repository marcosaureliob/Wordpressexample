...
function gt3_animation_wrapper_product_open(){
	echo '<div class="gt3-animation-wrapper gt3-anim-product '. ((gt3_option('modern_shop')== '1') ? esc_html('gt3_modern_shop_item') : "") .'">';
}
...
if (get_option('woocommerce_enable_ajax_add_to_cart') == 'yes') {
	add_action('wp_ajax_woocommerce_ajax_add_to_cart', 'gt3_woocommerce_ajax_add_to_cart');
	add_action('wp_ajax_nopriv_woocommerce_ajax_add_to_cart', 'gt3_woocommerce_ajax_add_to_cart');
}

function gt3_woocommerce_ajax_add_to_cart() {
